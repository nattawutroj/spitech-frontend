...
const Example = () => {
    ...
    function fecthData() {
        Axios.get('/resources/admin/roomt')
            .then(res => {
    ...
    const handleCreateUser = async ({ values, table }) => {
        console.log(values);
        if (values.topic !== '' ) {
            Axios.post('/resources/admin/roomt/add', values)
                .then(res => {
    ...
    const handleSaveUser = async ({ values, table }) => {
        console.log(values);
        Axios.put('/resources/admin/roomt/edit', values)
            .then(res => {
                console.log(res.data);
                Axios.get('/resources/admin/roomt')
                    .then(res => {
    ...
    const openDeleteConfirmModal = (row) => {
        ...
        if (window.confirm(`คุณต้องการลบข้อมูลนี้หรือไม่?`)) {
            Axios.delete('/resources/admin/roomt/delete', { data: { id_room: row.id } })
                .then(res => {
                    console.log(res.data);
                    Axios.get('/resources/admin/roomt')
                        .then(res => {
