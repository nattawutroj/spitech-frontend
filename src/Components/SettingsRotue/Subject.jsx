...
const Example = () => {
    ...
    function fecthData() {
        Axios.get('/resources/admin/subject')
            .then(res => {
    ...
    const handleCreateUser = async ({ values, table }) => {
        console.log(values);
        if (values.subject_name !== '' && values.credit !== '') {
            Axios.post('/resources/admin/subject/add', values)
                .then(res => {
    ...
    const handleSaveUser = async ({ values, table }) => {
        console.log(values);
        Axios.put('/resources/admin/subject/edit', values)
            .then(res => {
                console.log(res.data);
                Axios.get('/resources/admin/subject')
                    .then(res => {
    ...
    const openDeleteConfirmModal = (row) => {
        ...
        if (window.confirm(`คุณต้องการลบข้อมูลนี้หรือไม่?`)) {
            Axios.delete('/resources/admin/subject/delete', { data: { subject_code: row.id } })
                .then(res => {
                    console.log(res.data);
                    Axios.get('/resources/admin/subject')
                        .then(res => {
    ...
    const table = useMaterialReactTable({
        ...
        initialState: {
            ...
            sorting: [{ id: 'subject_code', desc: true }],
        },
        state: {
